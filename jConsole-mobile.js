...
var styleStr = ".f-t-idn{text-indent:20px}.f-t-idn2{text-indent:40px}.t-con-pop{position:fixed;width:100%;bottom:0;left:0;background:#f8f8f8;font-size:14px;color:#3a4149;z-index:10000}.t-con-pop div,span,p,a{margin:0;padding:0}.t-con-nav{overflow:hidden}.nav-item{height:30px;line-height:30px;display:inline-block;width:60px;text-align:center}.nav-item:hover{cursor:pointer;background:#d1d2d1}.nav-act{border-bottom:solid 2px #2196F3}.nav-close{font-size:20px;float:right;margin-right:10px;cursor:pointer}.body-item{height:240px;overflow-y:scroll}.t-con-top{border-top:solid 1px #b6b6b6;height:4px;cursor:n-resize;background:#e0e2e7}.t-con-nav{background:#e0e2e7}.t-net-nav{display:inline-block;width:80px;padding:0 5px;text-align:cnter;border-left:1px solid #d5d3d3}.j-stor-ipt{width:60px}.j-stor-del{color:red;float:right;cursor:pointer}.t-net-item,.t-tim-item{display:inline-block;width:80px;max-width:960px;padding:0 5px;border-left:1px solid #d5d3d3;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:left}.msg-item{border-bottom:solid 1px #d5d3d3;height:26px;line-height:26px;padding-left:10px}.u-ipt{width:100px}.u-ipt:focus{outline:none}.msg-info{background:#7bf77b}.msg-warn{background:#ffe400}.msg-err{background:#ED6666}#j-ck-search{position:absolute;top:34px;right:20px}@keyframes myfirst{from{transform:translateY(0%)}to{transform:translateY(100%)}}@-webkit-keyframes tclose{from{transform:translateY(0%)}to{transform:translateY(100%)}}@-webkit-keyframes topen{from{transform:translateY(100%)}to{transform:translateY(0%)}}.cont_close{transform:translateY(100%);animation:tclose 1s;-webkit-animation:tclose 1s}.cont_open{transform:translateY(0%);animation:topen 1s;-webkit-animation:topen 1s}.show-btn{display:none;position:fixed;bottom:50px;right:20px;width:60px;height:30px;line-height:30px;text-align:center;background:#7bf77b}";
